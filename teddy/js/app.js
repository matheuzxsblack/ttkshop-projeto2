(function () {
  ...
  function ttkProdId() {
    return String(window.TTK_STORE || "teddy").toLowerCase();
  }
  ...
  main.addEventListener("scroll", function () {
    ...
    var current = "geral";
    ["avaliacoes", "descricao", "recomendacoes"].forEach(function (name) {
  ...
  var PRICE = 28.17;
  var OLD_PRICE = 88.03;
  var EXTRA_PRICE = 21.49;
  var EXTRA_IMGS = [
    "images/hero-04.png", "images/hero-07.png", "images/hero-05.png", "images/hero-06.png",
    "images/hero-08.png", "images/hero-09.png", "images/color-caramelo.png",
  ];
  ...
  function itemHtml(item, i) {
    ...
    return (
      ...
      '<p class="cart-item-title">' + (item.extra ? "Cor surpresa — Casaquinho Teddy" : "Casaquinho Teddy Feminino Sherpa") + "</p>" +
      variantBtn +
  ...
  fetch(apiUrl("/api/checkout-mode?store=teddy"))
  ...
  function coItemHtml(item, i) {
    ...
    return (
      ...
      '<p class="co-item-title">' + (item.extra ? "Cor surpresa — Casaquinho Teddy" : "Casaquinho Teddy Feminino Sherpa") + "</p>" +
  ...
  function scItemHtml(item, i) {
    var title = item.extra ? "Cor surpresa — Casaquinho Teddy" : "Casaquinho Teddy Feminino Sherpa";
    var oldRow = item.extra
      ? ""
  ...
  function createPixCharge(total) {
    ...
    return fetch(apiUrl("/api/pix"), {
      ...
      body: JSON.stringify(Object.assign({
        amount: cents,
        origem: SIMULATE_MODE ? "simular" : (String(window.TTK_STORE || "teddy").toLowerCase() + "-ttkshop"),
        ...
        items_detail: cartItems.map(function (it) {
          return { variante: "Casaquinho Teddy " + it.label, qtd: it.qty };
        }),
  ...
  function firePurchasePixel(order, attempt) {
    ...
    function doTrack() {
      ...
      var contents = (order.items || []).map(function (it, i) {
        return {
          content_id: "teddy-" + String(it.label || i).replace(/\s+/g, "-").toLowerCase(),
          content_type: "product",
          content_name: it.extra ? "Cor surpresa — Casaquinho Teddy" : "Casaquinho Teddy " + (it.label || ""),
      ...
      var payload = {
        contents: contents.length
          ? contents
          : [{ content_id: "teddy", content_type: "product", content_name: "Casaquinho Teddy", quantity: 1, price: value }],
        content_type: "product",
        currency: "BRL",
        value: value,
      };
