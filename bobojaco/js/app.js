(function () {
  ...
  function ttkProdId() {
    return String(window.TTK_STORE || "bobojaco").toLowerCase();
  }
  ...
  function itemHtml(item, i) {
    ...
    return (
      ...
      '<p class="cart-item-title">' + (item.extra ? "Cor surpresa — Jaqueta Bobojaco Cot..." : "Jaqueta Feminina Cotêle Grosso Bob...") + "</p>" +
      variantBtn +
  ...
  fetch(apiUrl("/api/checkout-mode?store=bobojaco"))
  ...
  function coItemHtml(item, i) {
    ...
    return (
      ...
      '<p class="co-item-title">' + (item.extra ? "Cor surpresa — Jaqueta Bobojaco Cot..." : "Jaqueta Feminina Cotêle Grosso Bob...") + "</p>" +
  ...
  function scItemHtml(item, i) {
    var title = item.extra ? "Cor surpresa — Jaqueta Bobojaco Premium" : "Jaqueta Feminina Cotêle Grosso Bobojaco Capuz Removível";
    var oldRow = item.extra
      ? ""
  ...
  function createPixCharge(total) {
    ...
    return fetch(apiUrl("/api/pix"), {
      ...
      body: JSON.stringify(Object.assign({
        amount: cents,
        origem: SIMULATE_MODE ? "simular" : (String(window.TTK_STORE || "bobojaco").toLowerCase() + "-ttkshop"),
        ...
        items_detail: cartItems.map(function (it) {
          return { variante: "Bobojaco " + it.label, qtd: it.qty };
        }),
    ...
    function doTrack() {
      ...
      var contents = (order.items || []).map(function (it, i) {
        return {
          ...
          content_name: it.extra ? "Cor surpresa — Bobojaco" : "Bobojaco " + (it.label || ""),
